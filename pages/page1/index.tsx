    ...
    <>
      ...
      <Layout>
        ...
        <main className={styles.main}>
          <p>フェデラーが初めてGSタイトルを獲得した2003年から2023年WBまでの間、BIG4がどれだけタイトルを独占していたかを見てみます。</p>

          <p>期間中に開催されたGSは82大会あり、そのうちBIG4が獲得したタイトルは<strong>68</strong>に及び、獲得率は<strong>82.92%</strong>です。</p>
