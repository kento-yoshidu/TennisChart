  ...
  <>
    ...
    <Layout>
      <main className={styles.main}>
        <p>2022年、ロジャーフェデラーの引退。2023年、ラファエルナダルが全仏オープンを欠場し来季での引退の可能性があると発言。いよいよテニスBIG4の時代が終わりを告げようとしています（正確にはフェデラーが引退した時点で終わっていますが、2023年もジョコビッチが勝ちを重ねているため、いまいちその実感が湧きません）。</p>
