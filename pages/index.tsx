...
const Home = () => (
  <>
    ...
    <p>2022年、ロジャーフェデラーの引退。2023年、ラファエルナダルが全仏オープンを欠場し来季での引退の可能性があることを。いよいよテニスBig4の時代が終わりを告げようとしています（正確にはフェデラーが引退した時点で終わっていますが、2022年もジョコビッチが勝ちを重ねていたため、いまいちその実感が湧きません）。</p>
